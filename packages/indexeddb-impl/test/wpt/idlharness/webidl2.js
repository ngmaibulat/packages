// Via web-platform-tests/wpt commit 2cc8470b689fd1a9131c39bf93c84d7321c65358
(function webpackUniversalModuleDefinition(root, factory) {
    // Local change to the vendored UMD header: always publish the global, then
    // do whatever the module system asked for as well.
    //
    // idlharness.js reaches for a bare `WebIDL2`, and the converted test only
    // does `import "../idlharness/webidl2.js"` for the side effect. Node's ESM
    // loader leaves `module` and `exports` undefined, so the original fell
    // through to the `root[...]` branch and the global appeared. Bun treats
    // this .js as CJS, takes the first branch instead, and idlharness then dies
    // with "WebIDL2 is not defined".
    const webidl2 = factory();
    root["WebIDL2"] = webidl2;

    if (typeof exports === "object" && typeof module === "object")
        module.exports = webidl2;
    else if (typeof define === "function" && define.amd)
        define([], () => webidl2);
    else if (typeof exports === "object") exports["WebIDL2"] = webidl2;
})(globalThis, () => {
    return /******/ (() => {
        // webpackBootstrap
        /******/ "use strict";
        /******/ var __webpack_modules__ = [
            ...
            /***/ (
                ...
                function parse(str, options = {}) {
                    const tokeniser =
                        new _tokeniser_js__WEBPACK_IMPORTED_MODULE_0__.Tokeniser(
                            str,
                        );
                                ...
                                if (result !== -1) {
                                    if (reserved.includes(token.value)) {
                                        ...
                                        throw new WebIDLParseError(
                                            (0,
                                            _error_js__WEBPACK_IMPORTED_MODULE_0__.syntaxError)(
                                                tokens,
                                                lastIndex,
                                                null,
                                                message,
                                        ...
                                        nonRegexTerminals.includes(token.value)
                                    ) {
                                        token.type = "inline";
                                    }
                                }
            ...
            /***/ (
                ...
                function contextAsText(node) {
                    ...
                    return hierarchy
                        .map((n) => appendIfExist(n.type, n.name))
                        .join(" -> ");
                }
                ...
                function error(
                    ...
                    const precedingLastLine = lastLine(
                        tokensToText(sliceTokens(-maxTokens), {
                            precedes: true,
                        }),
                    );
                    ...
                    const inSourceName = source.name
                        ? ` in ${source.name}`
                        : "";
            ...
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ argument_list: () =>
                            /* binding */ argument_list,
                        /* harmony export */ autoParenter: () =>
                            /* binding */ autoParenter,
                        /* harmony export */ autofixAddExposedWindow: () =>
                            /* binding */ autofixAddExposedWindow,
                        /* harmony export */ const_data: () =>
                            /* binding */ const_data,
                        /* harmony export */ const_value: () =>
                            /* binding */ const_value,
                        /* harmony export */ findLastIndex: () =>
                            /* binding */ findLastIndex,
                        /* harmony export */ getFirstToken: () =>
                            /* binding */ getFirstToken,
                ...
                function list(
                    tokeniser,
                    { parser, allowDangler, listName = "list" },
                ) {
                ...
                function primitive_type(tokeniser) {
                    function integer_type() {
                        ...
                        if (base) {
                            ...
                            return new _type_js__WEBPACK_IMPORTED_MODULE_0__.Type(
                                { source, tokens: { prefix, base, postfix } },
                            );
                        }
                        if (prefix)
                            tokeniser.error("Failed to parse integer type");
                    }
                    ...
                    function decimal_type() {
                        ...
                        if (base) {
                            return new _type_js__WEBPACK_IMPORTED_MODULE_0__.Type(
                                { source, tokens: { prefix, base } },
                            );
                        }
                        if (prefix)
                            tokeniser.error("Failed to parse float type");
                    }
                ...
                function argument_list(tokeniser) {
                    return list(tokeniser, {
                        parser: _argument_js__WEBPACK_IMPORTED_MODULE_1__
                            .Argument.parse,
                ...
                function type_with_extended_attributes(tokeniser, typeName) {
                    ...
                    const ret =
                        _type_js__WEBPACK_IMPORTED_MODULE_0__.Type.parse(
                            tokeniser,
                            typeName,
                        );
                ...
                function return_type(tokeniser, typeName) {
                    ...
                    if (voidToken) {
                        const ret =
                            new _type_js__WEBPACK_IMPORTED_MODULE_0__.Type({
            ...
            /***/ (
                ...
                function generic_type(tokeniser, typeName) {
                    ...
                    ret.tokens.open =
                        tokeniser.consume("<") ||
                        tokeniser.error(
                            `No opening bracket after ${base.value}`,
                        );
                    switch (base.value) {
                        case "Promise": {
                            if (tokeniser.probe("["))
                            ...
                            const subtype =
                                (0,
                                _helpers_js__WEBPACK_IMPORTED_MODULE_1__.return_type)(
                                    tokeniser,
                                    typeName,
                        ...
                        case "record": {
                            ...
                            const valueType =
                                ...
                                tokeniser.error(
                                    "Error parsing generic type record",
                                );
                    ...
                    if (!ret.idlType)
                        tokeniser.error(
                            `Error parsing generic type ${base.value}`,
                        );
                    ret.tokens.close =
                        tokeniser.consume(">") ||
                        tokeniser.error(
                            `Missing closing bracket after ${base.value}`,
                        );
                    return ret.this;
                }
                ...
                function single_type(tokeniser, typeName) {
                    let ret =
                        ...
                        (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_1__.primitive_type)(
                            tokeniser,
                        );
                    if (!ret) {
                        const base =
                        ...
                        if (tokeniser.probe("<"))
                            tokeniser.error(
                                `Unsupported generic type ${base.value}`,
                            );
                    }
                ...
                class Type extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    get union() {
                        return (
                            Boolean(this.subtype.length) && !this.tokens.base
                        );
                    }
                    get idlType() {
                        ...
                        const name = [
                            ...
                            .join(" ");
                        return (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_1__.unescape)(
                            name,
                        );
                    }
                    ...
                    *validate(defs) {
                        ...
                        if (this.idlType === "BufferSource") {
                            ...
                            for (const extAttrs of [
                                this.extAttrs,
                                this.parent?.extAttrs,
                            ]) {
...
for more information.`;
                         ...
                         */
                        const typedef =
                            !this.union && defs.unique.get(this.idlType);
                    ...
                    write(w) {
                        const type_body = () => {
                            ...
                            const firstToken =
                                this.tokens.prefix || this.tokens.base;
                            ...
                            const ref = w.reference(
                                ...
                                {
                                    unescaped:
                                        /** @type {string} (because it's not union) */ (
                                            this.idlType
                                        ),
                                    context: this,
                                },
                ...
                function replaceAllowShared(type, extAttr, extAttrs) {
                    return () => {
                        ...
                        if (
                            !extAttrs.length &&
                            type.tokens.base.trivia.match(/^\s$/)
                        ) {
            ...
            /***/ (
                ...
                function idlTypeIncludesDictionary(
                    ...
                    if (!idlType.union) {
                        ...
                        if (def.type === "typedef") {
                            ...
                            defs.cache.typedefIncludesDictionary.set(
                                def,
                                undefined,
                            ); // indeterminate state
                            const result = idlTypeIncludesDictionary(
                                def.idlType,
                                defs,
                            );
                            defs.cache.typedefIncludesDictionary.set(
                ...
                function dictionaryIncludesRequiredField(dict, defs) {
                    if (defs.cache.dictionaryIncludesRequiredField.has(dict)) {
                        return defs.cache.dictionaryIncludesRequiredField.get(
                            dict,
                        );
                    }
                    ...
                    defs.cache.dictionaryIncludesRequiredField.set(
                        dict,
                        undefined,
                    );
                    ...
                    if (!result && dict.inheritance) {
                        ...
                        if (!superdict) {
                            ...
                            dictionaryIncludesRequiredField(superdict, defs)
                        ) {
                            result = true;
                        }
                    }
                ...
                function idlTypeIncludesEnforceRange(idlType, defs) {
                    ...
                    if (
                        idlType.extAttrs.some((e) => e.name === "EnforceRange")
                    ) {
                        return true;
                    }
                    ...
                    return def.idlType.extAttrs.some(
                        (e) => e.name === "EnforceRange",
                    );
                }
            ...
            /***/ (
                ...
                function tokens(tokeniser, tokenName) {
                    return (0, _helpers_js__WEBPACK_IMPORTED_MODULE_3__.list)(
                        tokeniser,
                        {
                ...
                const renamedLegacies = new Map([
                    .../** @type {[string, string][]} */ (
                        shouldBeLegacyPrefixed.map((name) => [
                            name,
                            `Legacy${name}`,
                        ])
                    ),
                        ...
                        if (tokens.open) {
                            ret.list = ret.rhsIsList
                                ...
                                : // [LegacyFactoryFunction=Audio(DOMString src)] or [Constructor(DOMString str)]
                                  (0,
                                  _helpers_js__WEBPACK_IMPORTED_MODULE_3__.argument_list)(
                                      tokeniser,
                                  );
                            tokens.close =
                                tokeniser.consume(")") ||
                    ...
                    get rhs() {
                        ...
                        const value = this.params.rhsIsList
                            ...
                            : this.params.tokens.secondaryName
                              ? (0,
                                _helpers_js__WEBPACK_IMPORTED_MODULE_3__.unescape)(
...
information.`;
                            yield (0,
                            _error_js__WEBPACK_IMPORTED_MODULE_4__.validationError)(
                                this.tokens.name,
                                this,
...
information.`;
                            ...
                            _error_js__WEBPACK_IMPORTED_MODULE_4__.validationError)(
                                ...
                                message,
                                {
                                    level: "warning",
                                    autofix:
                                        renameLegacyExtendedAttribute(this),
                                },
                            );
                        }
                ...
                class ExtendedAttributes extends _array_base_js__WEBPACK_IMPORTED_MODULE_1__.ArrayBase {
                    ...
                    static parse(tokeniser) {
                        ...
                        ret.push(
                            ...(0,
                            _helpers_js__WEBPACK_IMPORTED_MODULE_3__.list)(
                                tokeniser,
                                {
            ...
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        ...
                        /* harmony export */ WrappedToken: () =>
                            /* binding */ WrappedToken,
                        /* harmony export */
                    },
                );
                /* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ =
            ...
            /***/ (
                ...
                class Default extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    static parse(tokeniser) {
                        ...
                        const def =
                            (0,
                            _helpers_js__WEBPACK_IMPORTED_MODULE_1__.const_value)(
                                tokeniser,
                            ) ||
                        ...
                        if (def.value === "[") {
                            const close =
                                tokeniser.consume("]") ||
                                tokeniser.error(
                                    "Default sequence value must be empty",
                                );
                            ...
                            const close =
                                tokeniser.consume("}") ||
                                tokeniser.error(
                                    "Default dictionary value must be empty",
                                );
                            expression.push(close);
                        }
                        return new Default({
            ...
            /***/ (
                ...
                class Operation extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    static parse(tokeniser, { special, regular } = {}) {
                        ...
                        if (!special && !regular) {
                            tokens.special = tokeniser.consume(
                                "getter",
                                "setter",
                                "deleter",
                            );
                        ...
                        tokens.open =
                            tokeniser.consume("(") ||
                            tokeniser.error("Invalid operation");
                        ret.arguments = (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_1__.argument_list)(
                            tokeniser,
                        );
                        tokens.close =
                            tokeniser.consume(")") ||
            ...
            /***/ (
                ...
                class Enum extends _base_js__WEBPACK_IMPORTED_MODULE_2__.Base {
                    ...
                    static parse(tokeniser) {
                        ...
                        tokens.open =
                            tokeniser.consume("{") ||
                            tokeniser.error("Bodyless enum");
                        ret.values = (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_0__.list)(
                            tokeniser,
                            {
                    ...
                    get name() {
                        return (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_0__.unescape)(
                            this.tokens.name.value,
                        );
                    }
...
for more information.`;
                ...
                function autofixConstructor(interfaceDef, constructorExtAttr) {
                    interfaceDef = (0,
                    _helpers_js__WEBPACK_IMPORTED_MODULE_5__.autoParenter)(
                        interfaceDef,
                    );
                    return () => {
                        const indentation = (0,
                        ...
                        const memberIndent = interfaceDef.members.length
                            ? (0,
                              _helpers_js__WEBPACK_IMPORTED_MODULE_5__.getLastIndentation)(
                                  (0,
                                  _helpers_js__WEBPACK_IMPORTED_MODULE_5__.getFirstToken)(
                        ...
                        if (!extAttrs.length) {
                            extAttrs.tokens.open = extAttrs.tokens.close =
                                undefined;
            ...
            /***/ (
                ...
                class Container extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    get name() {
                        return (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_2__.unescape)(
                            this.tokens.name.value,
                        );
                    }
                    get inheritance() {
                    ...
                    write(w) {
                        const inheritance = () => {
                            ...
                            return w.ts.wrap([
                                ...
                                w.ts.inheritance(
                                    w.reference(this.tokens.inheritance.value, {
                                        context: this,
                                    }),
                                ),
                            ]);
            ...
            /***/ (
                ...
                class Constant extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    static parse(tokeniser) {
                        ...
                        let idlType = (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_2__.primitive_type)(
                            tokeniser,
                        );
                        if (!idlType) {
                            const base =
                            ...
                            idlType =
                                new _type_js__WEBPACK_IMPORTED_MODULE_1__.Type({
                                    source: tokeniser.source,
                                    tokens: { base },
                                });
                        }
                    ...
                    get value() {
                        return (0,
                        _helpers_js__WEBPACK_IMPORTED_MODULE_2__.const_data)(
                            this.tokens.value,
                        );
                    }
            ...
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ IterableLike: () =>
                            /* binding */ IterableLike,
                        /* harmony export */
                    },
                );
                /* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_0__ =
                ...
                class IterableLike extends _base_js__WEBPACK_IMPORTED_MODULE_1__.Base {
                    ...
                    static parse(tokeniser) {
                        ...
                        const first =
                            ...
                            tokeniser.error(
                                `Missing a type argument in ${type} declaration`,
                            );
                        ret.idlType = [first];
                        ret.arguments = [];
            ...
            /***/ (
                ...
                function* checkInterfaceMemberDuplication(defs, i) {
                    ...
                    for (const ext of [...partials, ...mixins]) {
                        ...
                        const statics = additions.filter(
                            (a) => a.special === "static",
                        );
                        const nonstatics = additions.filter(
                            (a) => a.special !== "static",
                        );
                        yield* checkAdditions(statics, opNames.statics, ext, i);
                        yield* checkAdditions(
                            nonstatics,
                            opNames.nonstatics,
                            ext,
                            i,
                        ...
                        nonstatics.forEach((op) =>
                            opNames.nonstatics.add(op.name),
                        );
                    }
            ...
            /***/ (
                ...
                class Field extends _base_js__WEBPACK_IMPORTED_MODULE_0__.Base {
                    ...
                    static parse(tokeniser) {
                        ...
                        ret.default =
                            _default_js__WEBPACK_IMPORTED_MODULE_3__.Default.parse(
                                tokeniser,
                            );
            ...
            /***/ (
                ...
                class Writer {
                    ...
                    reference_token(t, context) {
                        return this.token(t, this.reference.bind(this), {
                            context,
                        });
                    }
